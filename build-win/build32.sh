...
dotnet publish ../CraftHub/CraftHub.csproj --configuration Release --runtime win-x86 --self-contained -f net10.0
echo "Published"
...
# Other files
cp -f -a ../CraftHub/bin/Release/net10.0/win-x86/publish/. ./staging_folder32/ # copies all files from publish dir
